...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String initialBoard = setInitialBoard(); // Store the initial state of the board
        updateBoard(initialBoard); // Once there is aa initial state, it will be updated by every turn

    }

    public static String setInitialBoard() {
    ...
    public static void updateBoard(String currentBoard) {
        int x = 0;
        int y = 0;
    ...
    public static String printCharTurn() {
        turnX = !turnX;
        if (turnX) {
            return "X";
        }
